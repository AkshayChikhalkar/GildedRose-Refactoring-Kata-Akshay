...
public class GildedRoseTest
{
    ...
    public void NormalItem_QualityIsNeverNegative(){
        var items = new List<Item>{new Item{Name = "+5 Dexterity Vest", SellIn = 5, Quality = 0}};
        var app = new GildedRose(items);
        app.UpdateQuality();
    ...
    public void Backstage_IncreasesByOne_WhenSellInAbove10(){
        var items = new List<Item>{new Item{Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = 11, Quality = 0}};
        var app = new GildedRose(items);
        app.UpdateQuality();
    ...
    public void Backstage_IncreasesByTwo_WhenSellInBetween10And5(){
        var items = new List<Item>{new Item{Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = 10, Quality = 0}};
        var app = new GildedRose(items);
        app.UpdateQuality();
        Assert.Equal(9, items[0].SellIn);
        Assert.Equal(2, items[0].Quality);
